...
<TouchableOpacity onPress={()=> navigation.goBack()} 
          className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 " style={[styles.arrow]}>
        ...
        <Text style={[styles.not]}>Notification</Text>
          ...
          style={[styles.inputpilltime]}
             ...
             />
             <TouchableOpacity  style={[styles.plus]}><PlusIcon size="30" color="white" /></TouchableOpacity>
